  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('/api/create-trip', {
        ...
        body: JSON.stringify({country: formData.country, numberOfDays: formData.duration, travelStyle: formData.travelStyle, interests: formData.interest, budget: formData.budget, groupType: formData.groupType, userId: user.$id })
      });
    ...
    <main className="flex flex-col gap-10 pb-20 wrapper">
      ...
      <section className="mt-25 wrapper-md">
        <form className="trip-form" onSubmit={handleSubmit}>
          ...
          <div className="">
            <label htmlFor="location">Location on the world map
              <MapsComponent>
                <LayersDirective>
                  <LayerDirective
                    dataSource={mapData}
