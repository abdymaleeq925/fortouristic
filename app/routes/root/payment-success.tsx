...
const PaymentSuccess = ({loaderData}: Route.ComponentProps) => {
  ...
  return (
    <main className='payment-success wrapper'>
        <section>
            <article>
                <img src="/assets/icons/check.svg" alt="check" className='size-24'/>
                ...
                <ButtonComponent className='button-class !h-11 !w-full'>
                    <img src="/assets/icons/itinerary-button.svg" alt="button" className='size-5' />
                ...
                <ButtonComponent className='button-class-secondary !h-11 !w-full'>
                    <img src="/assets/icons/arrow-left.svg" alt="button" className='size-5' />
